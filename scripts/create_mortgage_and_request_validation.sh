...
execute_results_for_vo_setup=`curl --location --request POST 'http://localhost:'$cee_port'/p8e-cee-api/external/api/v1/p8e/validationoracle/execute' \
                                    --header 'x-uuid: 00000000-0000-0000-0000-000000000002' \
                                    --header 'Content-Type: application/json' \
                                    --data-raw '{
                                                    "provenanceConfig": {
...
execute_query_results_for_vo_setup=`curl --location --request GET 'http://localhost:'$cee_port'/p8e-cee-api/external/api/v1/p8e/validationoracle/query' \
                                    --header 'x-uuid: 00000000-0000-0000-0000-000000000002' \
                                    --header 'Content-Type: application/json' \
                                    --data-raw '{
                                                    "provenanceConfig": {
...
execute_vo_request=`curl --location --request POST 'http://localhost:'$cee_port'/p8e-cee-api/external/api/v1/p8e/validationoracle/execute' \
                                    --header 'x-uuid: 00000000-0000-0000-0000-000000000002' \
                                    --header 'Content-Type: application/json' \
                                    --data-raw '{
                                                    "provenanceConfig": {
...
execute_query_vo_request=`curl --location --request GET 'http://localhost:'$cee_port'/p8e-cee-api/external/api/v1/p8e/validationoracle/query' \
                                    --header 'x-uuid: 00000000-0000-0000-0000-000000000002' \
                                    --header 'Content-Type: application/json' \
                                    --data-raw '{
                                                    "provenanceConfig": {
                                                    ...
                                                    "libraryCall" :{
                                                        ...
                                                        "parameterClassJson": "{ \"id\": \"'$vo_request_id'\" }"
                                                    }
                                                }' 2>>results.txt`
